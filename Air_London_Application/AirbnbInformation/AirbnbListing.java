...
public class AirbnbListing {
    // Boolean value to indicate if a property is selected to be a favourite or not
    ...
    /**
     * Switch the boolean value based on the current boolean value
     */ 
    ...
    /**
     * Retrieve the boolean value to check if the property is a favourite or not
     * 
     * @return the boolean value to indicate if it is a favourite property or not
     */ 
